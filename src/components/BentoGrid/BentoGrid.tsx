...
import { BeamFive } from "../AnimatedBeams/BeamFive/BeamFive";
import { BeamFour } from "../AnimatedBeams/BeamFour/BeamFour";
...
const features = [
  ...
  },
  {
    ...
    className: "col-span-3 lg:col-span-2",
    background: (
      <BeamFive className="absolute right-2 top-4 h-[300px] w-[600px] border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105" />
    ),
  },
  {
    Icon: CalendarIcon,
